...
if __name__ == "__main__":
    try:
        parser = argparse.ArgumentParser(description="Deploy Terraform stacks for the machine learning pipeline.")
        ...
        group.add_argument("--jobs-only", action="store_true", help="Deploy only the jobs stack")
        ...
        if args.rg_only:
            ...
            tf_dirs = [rg_dir, dbx_dir, compute_dir, notebooks_dir, jobs_dir]
